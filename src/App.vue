    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
      ...
      <ul class="mb-4">
        <li
          ...
          class="mb-2"
        >
          <span class="font-bold">{{ product.name }}</span> - Quantity:
          {{ product.quantity }}, Price: ${{ product.price.toFixed(2) }}
          <span v-if="product instanceof DigitalProduct">
            (Download: {{ product.downloadLink }})</span
          >
          <span v-if="product instanceof PhysicalProduct">
            (Weight: {{ product.weight }})</span
          >
          <span v-if="product instanceof SubscriptionProduct">
            (Duration: {{ product.subscriptionDuration }} months)</span
          >
        </li>
      </ul>
  ...
  switch (productType.value) {
    ...
    case 'subscription':
      product = new SubscriptionProduct(
        ...
        parseFloat(productPrice.value),
        parseInt(productQuantity.value),
        parseInt(subscriptionDuration.value)
      );
      break;
  }
